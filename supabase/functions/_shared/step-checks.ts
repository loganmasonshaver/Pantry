...
const SEASONING = /\b(salt|salted|pepper|peppercorns?)\b/i
...
export function stepIssues(meal: { ingredients?: unknown; steps?: unknown } | null | undefined): StepIssues {
